import 'dart:async';
import 'dart:convert';
import 'package:ecommerce_app_ui_kit/src/firebase/auth/data_models/countries.dart';
...
class PhoneAuthGetPhone extends StatefulWidget {
   ...
   */
  Color cardBackgroundColor = Color(0xFF009DB5);
