...
class CartDetailsWidget extends StatefulWidget {
  final Map<String, int> combinationsIds;

  CartDetailsWidget({Key key, @required this.combinationsIds})
      : super(key: key);
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FutureBuilder(
                    future: cartService.getCartCombinations(widget.combinationsIds),
                      ...
                      if(snapshot.hasData) {
                        ...
                        itemBuilder: (context, index) {
                          return CartItemWidget(
                              combination: snapshot.data[index],
                              heroTag: 'cart');
                        },
                      );
                      } else {
